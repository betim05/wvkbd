...
static struct layout layouts[NumLayouts] = {
  [Full] = {keys_full, "latin", "de", true}, // second parameter is the keymap name
...
static struct key keys_full[] = {
  ...
  {"ß", "?", 1.0, Code, KEY_MINUS, &layouts[ComposeBracket]},
  ...
  {"z", "Z", 1.0, Code, KEY_Y, &layouts[ComposeZ]},
  ...
  {"ä", "Ä", 1.0, Code, KEY_APOSTROPHE, &layouts[ComposeBracket]},
  {"Enter", "Enter", 1.5, Code, KEY_ENTER, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"⇧", "⇫", 2.5, Mod, Shift, .scheme = 1},
  {"y", "Y", 1.0, Code, KEY_Z, &layouts[ComposeY]},
...
static struct key keys_index[] = {
  {"De", "De", 1.0, Layout, 0, &layouts[Full], .scheme = 1},
